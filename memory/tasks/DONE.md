...
- [x] TASK-012: 修正 GitHub 上传失败后的 memory 状态，将错误标记为成功的 TASK-011 重新落盘为阻塞态
- [x] TASK-013: 对齐 IsaacLab-Quadruped-Tasks 楼梯课程结构，补齐 Unitree B2 stair play 配置、play 任务注册与迁移说明文档
